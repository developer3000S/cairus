...
- **Примеры инструментов:**
  Примеры того, как реализовать размещённые в облаке инструменты (например, веб-поиск и поиск по файлам)
  и интегрировать их в агенты.

- **Поставщики моделей:**
  Примеры использования моделей, отличных от OpenAI, с SDK.
